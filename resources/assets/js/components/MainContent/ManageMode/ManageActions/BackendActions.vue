      ...
      <div class="buttons">
        ...
        <div class="action">
          <button title="Generate Resource" :disabled="tableHasResource !== false"
            ...
            <i class="ri-table-alt-fill mr-1"></i>
        ...
        <div class="action">
          <button title="Generate new factory" :disabled="tableHasFactory" @click="generate('factory')">
            <i class="ri-building-3-fill mr-1"></i>
        ...
        <div class="action">
          <button title="Generate new seeder" :disabled="tableHasSeeder !== false"
            ...
            <i class="ri-seedling-fill mr-1"></i>
...
export default {
  ...
  methods: {
    ...
    generate: async function (generator) {
      ...
      await api.get(`/database/${generator}/${this.$root.table.database}/${this.$root.table.table}/generate`).then(res => {
        if (res) {
